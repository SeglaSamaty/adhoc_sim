...
main (int argc, char *argv[])
{
  ...
  int nSinks = 10; 	// Nombre de source-destination
  double txp = 7.5;	//Puissance d'emision 
  ...
  //ns3::RngSeedManager::SetSeed(7497);
  //ns3::RngSeedManager::SetRun(707);
  ...
  Ptr<OutputStreamWrapper> osw = ascii.CreateFileStream ( (tr_name + "2b.tr").c_str());
  wifiPhy.EnableAsciiAll (osw);

  NS_LOG_INFO ("Run Simulation.");


  AnimationInterface anim("anims/anim2.xml");
